		...
		<x-container>
			...
			<div class="offcanvas offcanvas-end" tabindex="-1" id="navbarOffcanvasLg" aria-labelledby="navbarOffcanvasLgLabel">
				...
				<div class="offcanvas-body">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						<li class="nav-item">
						  <a href="{{ route('about') }}" class="nav-link" aria-current="page" >Про нас</a>
						</li>
						<li class="nav-item">
							<a href="{{ route('advantages') }}" class="nav-link" aria-current="page" >Переваги</a>
						 </li>
						<li class="nav-item">
						  <a href="{{ route('cards') }}" class="nav-link " >Картки</a>
					  </li>
					  <li class="nav-item">
			...
			<div class="d-flex" >
				<button class="btn btn-light mx-1" type="button" >
					<a href="{{ route('login') }}" class="nav-link">Кабінет</a>
				</button>
